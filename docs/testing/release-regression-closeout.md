...
| Task hierarchy drag/drop rejection | Release E2E verifies DB/API rejection for invalid hierarchy writes; unit coverage verifies UI move/drop guard helpers. | Covered below UI; UI drag/drop E2E remains legacy, not release gate |

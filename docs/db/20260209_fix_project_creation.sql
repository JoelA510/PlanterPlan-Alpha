-- Migration: 20260209_fix_project_creation.sql
-- Purpose: Fix RLS Deadlock by auto-inserting creator into project_members via SECURITY DEFINER RPC.
...
BEGIN
    ...
    -- the creator from adding themselves via valid client-side calls.

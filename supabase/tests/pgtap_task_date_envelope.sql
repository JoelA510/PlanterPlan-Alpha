...
SET start_date = '2026-01-01 00:00:00+00'::timestamptz,
    due_date = '2026-01-31 00:00:00+00'::timestamptz
WHERE id = '11111111-1111-1111-1111-111111111801';

UPDATE public.tasks
SET start_date = '2026-01-03 00:00:00+00'::timestamptz,
    due_date = '2026-01-29 00:00:00+00'::timestamptz
WHERE id = '22222222-2222-2222-2222-222222222801';

UPDATE public.tasks
SET start_date = '2026-01-08 00:00:00+00'::timestamptz,
    due_date = '2026-01-20 00:00:00+00'::timestamptz
...
UPDATE public.tasks
SET start_date = '2026-01-21 00:00:00+00'::timestamptz,
    due_date = '2026-01-25 00:00:00+00'::timestamptz
WHERE id = '33333333-3333-3333-3333-333333333802';
...
UPDATE public.tasks
SET start_date = '2026-01-10 00:00:00+00'::timestamptz,
    due_date = '2026-01-15 00:00:00+00'::timestamptz
...
SET start_date = NULL,
    due_date = NULL
WHERE id = '33333333-3333-3333-3333-333333333803';

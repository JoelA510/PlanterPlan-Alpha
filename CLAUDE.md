...
- **TypeScript only** — no `.js` or `.jsx` files. Ever. (One documented exception: `public/sw.js`, the Wave 30 push-notification service worker. TS conversion is not currently scheduled — the former Wave 32 PWA/workbox track was descoped. See `docs/dev-notes.md`.)

  ...
  const features = [
    {
      ...
      description: "Break down your church plant into 6 manageable phases with clear milestones and actionable tasks."
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "Set your launch date and let the system calculate optimal timelines for each task."
    },
    {
      icon: BarChart3,
      title: "Progress Tracking",
      description: "Visual reports and dashboards help you see exactly where you stand at any moment."
    }
  ];
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-24 md:py-32">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed">
              Focus on what matters most — people. Let PlanterPlan handle the details,
              timelines, and tasks so you can lead with clarity and purpose.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to={createPageUrl('Dashboard')}>
                <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-6 text-lg rounded-xl shadow-lg shadow-orange-500/25 transition-all hover:shadow-xl hover:shadow-orange-500/30">
                  Get Started Free
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="border-slate-600 text-slate-300 hover:bg-slate-800 px-8 py-6 text-lg rounded-xl">
                Watch Demo
              </Button>
            </div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Built by planters, for planters. Every feature designed to keep you focused on ministry.
            </p>
          </motion.div>
      ...
      <section className="py-20 md:py-28 px-4 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Choose a template that fits your vision. Each one is based on real-world church planting experience.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-lg text-slate-300 mb-8 max-w-xl mx-auto">
                Join hundreds of church planters who use PlanterPlan to stay organized and focused on people.
              </p>
              <Link to={createPageUrl('Dashboard')}>
      ...
      <footer className="border-t border-slate-200 py-12 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-slate-500">
            Helping church planters focus on what matters most.
          </p>
        </div>
      </footer>
    </div>

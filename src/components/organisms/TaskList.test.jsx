...
jest.mock('../molecules/ProjectTasksView', () => () => <div data-testid="project-tasks-view">ProjectTasksView</div>);
...
jest.mock('../templates/TaskDetailsView', () => () => <div data-testid="task-details-view">TaskDetailsView</div>);
